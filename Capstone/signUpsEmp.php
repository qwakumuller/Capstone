...
<body>
  ...
  <?php $page ='employeeSignUp'; include 'include/menu.php'; ?>
  <br>
<div id= "error codes">
  <br>
  <?php
  ...
  ?>
    ...
    <form action="include/regesterEmployeeScript.php" id = "regesterEmployeeForm" method = "post">
        ...
        <button type="submit" name="regesterEmployeesButton">Submit</button>
      </form> 

      <br>
      <br>
      <a href = "signInEmp.php">Click Here to sign in instead </a>
